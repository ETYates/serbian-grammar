...
\setmainfont{OldStandardTT-Regular.ttf}[
    BoldFont=OldStandardTT-Bold.ttf,
    ItalicFont=OldStandardTT-Italic.ttf,
]
\setotherlanguage{serbian}
\setotherlanguage[variant=polytonic]{greek}
\newfontfamily\serbianfont[Ligatures=TeX]{OldStandardTT-Regular.ttf}
...
\titleformat{\chapter}{\normalfont\large}{\centering\normalfont \thechapter.}{5pt}{\large\centering}
